...
namespace Modules\ModuleCzechLanguagePack\App\Controllers;

use MikoPBX\AdminCabinet\Controllers\BaseController;
use MikoPBX\Modules\PbxExtensionUtils;

/**
 * ModuleCzechLanguagePackController
 *
 * Controller for Czech Language Pack module information page
 */
class ModuleCzechLanguagePackController extends BaseController
{
    private string $moduleUniqueID = 'ModuleCzechLanguagePack';
    ...
    public function indexAction(): void
    {
        ...
        // Count sound files
        $soundsDir = $this->moduleDir . '/Sounds/cs-cs';
        $soundFileCount = 0;
        if (is_dir($soundsDir)) {
        ...
        $messagesDir = $this->moduleDir . '/Messages/cs';
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-czech-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-czech-language-pack-progress.js", true);
    ...
    public function soundsAction(): void
    {
        ...
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-czech-language-pack-sounds-api.js", true);
        $footer->addJs("js/cache/{$this->moduleUniqueID}/module-czech-language-pack-sounds-index.js", true);
