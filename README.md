...
Complete Czech language pack for MikoPBX including UI translations and voice prompts.

## What's Included

- **Voice Prompts**: Czech voice prompts for system menus, greetings, and notifications
- **UI Translations**: Complete Czech translation of MikoPBX admin interface
- **Text Mapping**: `Sounds/core-sounds-cs-cs.txt` — full list of prompts with text
...
- **Voice model**: `cs_CZ-jirka-medium`
- **Sample rate**: 22050 Hz
- **Format**: WAV (PCM signed 16-bit, mono)

The text for each prompt is stored in `Sounds/core-sounds-cs-cs.txt` for reference and regeneration.
...
3. Go to **General Settings** and select Czech (Čeština) as the system language
