...
namespace Modules\ModuleCzechLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleCzechLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * CzechLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class CzechLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-czech-language-pack';
