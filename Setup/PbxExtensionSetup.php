...
namespace Modules\ModuleCzechLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Czech Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Czech UI translations from Messages/cs/ directory
 * - Czech voice prompts from Sounds/cs-cs/ directory
 *
 ...
 *
 * @package Modules\ModuleCzechLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleCzechLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Czech packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Czech Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Czech Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Czech Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Czech Language Pack uninstalled successfully',
            LOG_INFO
        );
